  ...
  return (
    <div>
      ...
      <div className="w-[100%] max-w-[95%] md:max-w-[60%] m-auto py-10 text-justify font-medium">
        ...
        <p>The country’s geography ranges from the high Himalayas in the north to the fertile Terai plains in the south, supporting a rich biodiversity, including endangered species like the Bengal tiger and one-horned rhinoceros. The climate varies widely, with alpine conditions in the mountains and subtropical weather in the lowlands.</p>
        <p>Culturally, Nepal is rich in traditions, festivals, and religious practices. Key festivals include Dashain, Tihar, and Holi, celebrated with vibrant rituals, music, and dances. Nepalese cuisine features dishes like dal bhat (lentil soup with rice) and momo dumplings, influenced by Indian and Tibetan flavors.</p>
        <p>Nepal’s natural beauty, rich culture, and historical significance make it a unique and revered nation, drawing visitors and pilgrims from around the world.</p>
      </div>
    </div>
  )
}
