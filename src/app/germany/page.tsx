  ...
  return (
    <div>
      ...
      <div className="w-[100%] max-w-[95%] md:max-w-[60%] m-auto py-10 text-justify font-medium">
        ...
        <p>Germany’s geography is diverse, featuring the Alps in the south, dense forests and rolling hills in central regions, and river plains like the Rhine and Danube. This diversity supports agriculture and tourism, with attractions ranging from the Bavarian Alps to the scenic Black Forest and historical castles along the Rhine River.</p>
        <p>Culturally, Germany has a profound influence on art, philosophy, music, and literature. Figures like Goethe, Beethoven, and Einstein are celebrated worldwide, and Germany is known for its contributions to classical music, philosophy, and science. Oktoberfest, a world-famous beer festival in Munich, highlights Germany’s beer culture, while German cuisine includes dishes like sausages, pretzels, schnitzel, and hearty stews.</p>
        <p>Germany’s pivotal role in European politics, economic strength, and commitment to sustainability make it a central player in global affairs. Its blend of tradition and innovation continues to shape both its national identity and influence worldwide.</p>
      </div>
    </div>
  )
}
