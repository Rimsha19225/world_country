  ...
  return (
    <div>
      ...
      <div className="w-[100%] max-w-[95%] md:max-w-[60%] m-auto py-10 text-justify font-medium">
        ...
        <p>Geographically, Togo is a narrow, elongated country with diverse landscapes, from coastal plains in the south to rolling savannas and plateaus in the central and northern regions. The Togo Mountains stretch across the country, offering scenic beauty and supporting a variety of flora and fauna, including protected areas like Fazao-Malfakassa National Park.</p>
        <p>Togolese culture is a blend of traditional African customs and French influences, with music, dance, and festivals playing a central role in daily life. Traditional crafts, such as weaving, pottery, and beadwork, are practiced and celebrated. Togo’s vibrant music scene includes genres like Afrobeat, highlife, and traditional drumming and dance performances, reflecting the country’s rich cultural heritage.</p>
        <p>Togo’s unique landscapes, cultural diversity, and natural resources contribute to its potential for growth and development. As it continues to focus on economic diversification and political stability, Togo holds promise as a distinctive and resilient West African nation.</p>
      </div>
    </div>
  )
}
