  ...
  return (
    <div>
      ...
      <div className="w-[90%] p-10 ml-20 font-medium">
        ...
        <p>Geographically, Bangladesh is characterized by its river delta landscape, formed by the Padma, Jamuna, and Meghna rivers, which contribute to the country’s fertile lands. However, it is also prone to flooding and other climate-related challenges due to its low-lying geography. The Sundarbans, a UNESCO World Heritage site and the world’s largest mangrove forest, is home to the Bengal tiger and a significant ecological treasure.</p>
        <p>Bangladesh has a rich cultural heritage that includes traditional music, dance, art, and festivals like Pohela Boishakh (Bengali New Year) and Eid celebrations. Bengali cuisine is known for its flavorful rice and fish dishes, biryani, and sweets like rasgulla and sandesh.</p>
        <p>Despite its challenges, Bangladesh continues to make strides in development, with a strong focus on women’s empowerment, healthcare, and education. Its resilience and dynamic growth make it a key player in South Asia.</p>
      </div>
    </div>
  )
}
