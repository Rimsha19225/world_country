  ...
  return (
    <div>
      ...
      <div className="w-[90%] p-10 ml-20 font-medium">
        ...
        <p>China has a cultural heritage spanning thousands of years, with profound influence on philosophy, art, science, and technology. Confucianism, Taoism, and Buddhism are deeply rooted in Chinese culture, impacting values and traditions. Chinese arts, such as calligraphy, painting, martial arts, and traditional Chinese medicine, are internationally recognized. Festivals like the Lunar New Year, Mid-Autumn Festival, and the Dragon Boat Festival are celebrated widely.</p>
        <p>Chinese cuisine is world-famous, known for its diversity, with regional dishes like Sichuan spicy hotpot, Cantonese dim sum, and Peking duck. As a leading global power, China’s historical depth, economic strength, and cultural influence make it a pivotal country on the world stage.</p>
      </div>
    </div>
  )
}
