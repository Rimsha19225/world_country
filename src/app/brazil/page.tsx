  ...
  return (
    <div>
      ...
      <div className="w-[90%] p-10 ml-20 font-medium">
        ...
        <p>Geographically, Brazil is famous for the Amazon Rainforest, the world’s largest tropical rainforest, which plays a crucial role in global biodiversity and climate regulation. The country also boasts diverse landscapes, from the Pantanal wetlands and the Atlantic Forest to savannas and coastal beaches, supporting rich wildlife.</p>
        <p>Brazilian culture is vibrant and celebrated worldwide, known for its music (samba, bossa nova), Carnival festival, and love for football (soccer). Brazilian cuisine includes regional dishes like feijoada (a black bean and pork stew), pão de queijo (cheese bread), and tropical fruits like açaí.</p>
        <p>Brazil’s unique mix of culture, biodiversity, and economic potential, alongside its natural wonders like the Amazon and Iguazu Falls, make it an influential and captivating nation on the global stage.</p>
      </div>
    </div>
  )
}
