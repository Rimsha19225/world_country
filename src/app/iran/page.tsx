  ...
  return (
    <div>
      ...
      <div className="w-[100%] max-w-[95%] md:max-w-[60%] m-auto py-10 text-justify font-medium">
        ...
        <p>Geographically, Iran is known for its varied landscape, with mountain ranges such as the Alborz and Zagros, expansive deserts like Dasht-e Kavir, and coastal plains along the Caspian Sea and the Persian Gulf. Iran’s historical sites, including Persepolis, ancient mosques, and palaces, reflect its rich history as the heart of the Persian Empire.</p>
        <p>Culturally, Iran has a long-standing tradition in art, poetry, music, and cuisine. Persian poetry from poets like Hafez and Rumi is widely celebrated, and traditional Persian arts such as carpet weaving, calligraphy, and miniature painting are renowned globally. Iranian cuisine, famous for dishes like kebabs, stews (khoresh), and rice dishes such as saffron-infused tahdig, highlights the country’s culinary richness.</p>
        <p>Iran’s combination of ancient heritage, natural beauty, and cultural influence positions it as a unique and influential nation within the Middle East and globally.</p>
      </div>
    </div>
  )
}
