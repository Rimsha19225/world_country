  ...
  return (
    <div>
      ...
      <div className="w-[100%] max-w-[95%] md:max-w-[60%] m-auto py-10 text-justify font-medium">
        ...
        <p>Economically, Libya is heavily reliant on its vast oil reserves, which are some of the largest in Africa. Oil exports provide most of the country’s revenue, and the petroleum sector plays a key role in shaping Libya’s economy. However, due to internal conflicts, oil production has been disrupted, and the economy has faced significant challenges, including high unemployment rates, inflation, and shortages of basic goods. The country also has significant natural gas resources, and agriculture is a minor sector, with date palms being a notable crop.</p>
        <p>Libya geography is dominated by the Sahara Desert, which covers much of the country’s land area. Coastal regions are more fertile and populated, while the interior is arid and sparsely inhabited. The country has a warm desert climate, with hot, dry summers and mild winters.</p>
        <p>Culturally, Libya has a mix of Arab, Berber, and Mediterranean influences, with Islam being the predominant religion. The country’s art, literature, and music reflect this blend of traditions, although many cultural activities have been limited under authoritarian rule. Libyan cuisine includes Mediterranean and North African flavors, with dishes such as couscous, shakshuka, and meat stews being common.</p>
        <p>Libya’s current situation remains uncertain, but there are efforts underway to stabilize the country and rebuild its institutions, while the international community continues to offer support for peace and reconciliation.</p>
      </div>
    </div>
  )
}
